...
export const createBlogCategory = createAsyncThunk(
    ...
    async (blogCategoryData, thunkAPI) => {
        try {
            return await blogCategoryService.createBlogCategory(
                blogCategoryData
            );
        } catch (error) {
            return thunkAPI.rejectWithValue(error);
...
export const getABlogCategory = createAsyncThunk(
    ...
    async (blogCategoryData, thunkAPI) => {
        try {
            return await blogCategoryService.getBlogCategory(blogCategoryData);
        } catch (error) {
            return thunkAPI.rejectWithValue(error);
        }
    }
...
export const updateABlogCategory = createAsyncThunk(
    ...
    async (blogCategoryData, thunkAPI) => {
        try {
            return await blogCategoryService.updateBlogCategory(
                blogCategoryData
            );
        } catch (error) {
            return thunkAPI.rejectWithValue(error);
...
export const deleteABlogCategory = createAsyncThunk(
    ...
    async (blogCategoryData, thunkAPI) => {
        try {
            return await blogCategoryService.deleteBlogCategory(
                blogCategoryData
            );
        } catch (error) {
            return thunkAPI.rejectWithValue(error);
